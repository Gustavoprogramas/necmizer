...
bool InjetarDLL(HANDLE hProc, const char* dllNome) {
    ...
    // endereço da função LoadLibraryA do Windows
...
void ExecutarOtimizador(int choice) {
    ...
    /** std::vector<MemoryFlag> flags = {
        {"TaskSchedulerTargetFps", 0x77958B4, 9999},
        {"RenderShadowmapBias", 0x6A3B178, -1},
        {"FastGPULightCulling3", 0x77D7030, 1},
        {"DebugForceMSAASamples", 0x775B52C, 1},
        {"FRMMaxGrassDistance", 0x6A46C88, 0},
        {"DebugFRMQualityLevelOverride", 0x775EAC4, 4},
        {"HandleAltEnterFullscreenManually", 0x78AB208, 1},
        {"RakNetLoopMs", 0x6A40538, 1},
        {"RakNetPingFrequencyMillisecond", 0x6A3F12C, 10},
        {"ClientPacketMaxDelayMs", 0x6A3ACBC, 1},
        {"ClientPacketMaxFrameMicroseconds", 0x6A3ACC8, 1},
        {"ClientPacketHealthyMsPerSecondLimit", 0x6A3ACD4, 1},
        {"MaxProcessPacketsJobScaling", 0x6A3ACAC, 2139999999},
        {"MaxProcessPacketsStepsAccumulated", 0x6A3ACB8, 0},
        {"MaxProcessPacketsStepsPerCyclic", 0x6A3ACB4, 2139999999},
        {"S2PhysicsSenderRate", 0x6A5286C, 1},
        {"WorldStepMax", 0x6A3EAC8, 1},
        {"MaxMissedWorldStepsRemembered", 0x6A3EABC, 1},
        {"RakNetResendBufferArrayLength", 0x6A40864, 128},
        {"RakNetResendMaxThresholdTimeInUs", 0x6A40894, 10000},
        {"RakNetResendMinThresholdTimeInUs", 0x6A40890, 5000},
        {"RakNetResendRttMultiple", 0x6A4088C, 1},
        {"RakNetResendScaleBackFactorHundredthsPercent", 0x775E560, 50},
        {"InterpolationMaxDelayMSec", 0x6A3EB34, 1},
        {"InterpolationAwareTargetTimeLerpHundredth", 0x6A3EB2C, 100},
        {"InterpolationDtLimitForLod", 0x6A3EBBC, 1},
        {"DebugSimPrimalStiffnessMax", 0x6A47370, 0},
        {"BloomFrmCutoff", 0x6A3AFB0, -1},
        {"RobloxGuiBlurIntensity", 0x6A560B4, 0},
        {"RenderLocalLightUpdatesMax", 0x6A3B188, 1},
        {"ClientPacketExcessMicroseconds", 0x6A3ACC0, 1},
        {"DiffractionSolverUsesGraphicsQualityLevel", 0x7876538, 3},
        {"GameNetPVHeaderRotationOrientIdToleranceExponent", 0x6A3ACF4, -1},
        {"RenderLocalLightUpdatesMin", 0x6A3B184, 1},
        {"RenderLocalLightFadeInMs", 0x6A3B18C, 0},
        {"RenderReportGfxQualityLevel", 0x77D2900, 1},
        {"SimBlockLargeLocalToolWeldManipulationsThreshold", 0x6A3AC84, -1}
    }; */
    ...
    switch (uMsg) {
        case WM_CREATE:
            hBtn1 = CreateWindowA("BUTTON", "1 - Otimizar e Colocar Bandeiras",
                ...
                20, 20, 250, 40, hwnd, (HMENU)1, NULL, NULL);
            
            hBtn2 = CreateWindowA("BUTTON", "2 - Apenas Otimizar",
                WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON,
                20, 70, 250, 40, hwnd, (HMENU)2, NULL, NULL);

            hStatus = CreateWindowA("STATIC", "Status: Aguardando escolha...",
                WS_VISIBLE | WS_CHILD,
                20, 130, 250, 40, hwnd, NULL, NULL, NULL);
            break;
...
// bash: g++ -o app.exe final.cpp -static -lkernel32 -luser32 -lwinmm -mwindows